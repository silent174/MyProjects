$(document).ready(function() {
	...
	$(window).resize(function(){
	    ...
	    if(w > 992) {
	        ...
	        pull.removeClass('navigation_toggle-button--active');
	    } else {
	...
	function fnstart(){	
		if ( $("#navigation-toggle").hasClass("navigation_toggle-button--active")  ) {
   			pull.toggleClass('navigation_toggle-button--active');
			menu.slideToggle();
		}
	};
